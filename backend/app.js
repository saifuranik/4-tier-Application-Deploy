...
mongoose.connect(
  'mongodb+srv://bogemek835:a4fSLaJTkVfseUFz@anik.plzsz.mongodb.net/?retryWrites=true&w=majority&appName=anik',
  {
...
// mongoose.connect(
//   process.env.MONGO_URL, { useNewUrlParser: true, useUnifiedTopology: true }, (err) => {
//   if (err) {
